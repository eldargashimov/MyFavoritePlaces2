...
class MainViewController: UITableViewController {
    ...
    let restorauntNames = ["Балкан Гриль", "Бочка", "Вкусные истории", "Дастархан", "Индокитай",
                           "Burger Heroes", "Классик", "Шок", "Bonsai", "Kitchen",
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelName.text = restorauntNames[indexPath.row]
